const data = {
    ...
    "categories": [{"id": 1, "name": "Новости"}, {"id": 2, "name": "Торренты"}, {"id": 3, "name": "Курсы"}, {
        "id": 4,
        "name": "О проекте"
...
const smallNewsTemplate = document.getElementById('small-article-items');
...
//         <img className="main-article__image" src="./images/image.jpg" alt="Фото новости"/>
//     </div>
//     <div className="main-article__content">
//         <span className="article-category main-article__category">Новости</span>
//         <h2 className="main-article__title">Вещи, которые нужно знать перед стажировкой в IT сфере</h2>
//         <p className="main-article__text">Уличные музыканты продолжают радовать фанатов стрит арта. Для этого они
//             исполняют привычные мелодии в новом формате!</p>
...
//     <h2 className="small-article__title">Как начать год так, чтобы потом было приятно подводить итоги: чек-лист</h2>
